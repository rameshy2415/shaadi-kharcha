...
//min-h-screen
  ...
  return (
    <div className="bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div>
                <a
                  href="#"
                  className="w-full inline-flex justify-center items-center py-2 px-4 border border-pink-300 rounded-md shadow-sm bg-white text-sm font-medium text-pink-500 hover:bg-gray-50"
                >
